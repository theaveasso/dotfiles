...
if is_available "telescope.nvim" then
  ...
  maps.n["<leader>sR"] = { function() require("telescope.builtin").resume() end, desc = "Resume previous search" }
  ...
  maps.n["<leader>l"] = sections.l
  maps.n["<leader>lD"] = { function() require("telescope.builtin").diagnostics() end, desc = "Find diagnostics" }
  maps.n["<leader>ls"] = {
    function()
